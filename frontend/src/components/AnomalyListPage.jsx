            ...
            <div className="mainContainer">
                ...
                <div className="anomalyContainer">
                    {loading ? (
                        ...
                        searchedAnomalies.map((a) => <AnomalyCard key={a.representative_id} id={a.representative_id} title={a.title} atm_id={a.atm_id} severity={a.representative_severity} anomaly_type={a.anomaly_type} update_time={formatTime(a.latest_detected_at)} is_starred={a.is_starred} toggle_star={() => handleStar(a.representative_id)} />)
                    )}
                </div>
            </div>
        </>
