...
class TestGetUnsyncedAnomalies:
    def test_returns_list_of_anomalies(self):
        ...
        mock_cursor.fetchall.return_value = [{
            "id": 1, "detected_at": "2026-03-05T09:15:00+00:00",
            "anomaly_type": "A1", "atm_id": "ATM-GB-0001",
...
class TestSyncOnce:
    ...
    def test_sync_once_with_anomalies(self):
        ...
        mock_cursor.fetchall.return_value = [{
            "id": 1, "detected_at": ts,
            "anomaly_type": "A1", "atm_id": "ATM-GB-0001",
            "severity": "CRITICAL", "title": "Test", "explanation": "{}",
        }]
        mock_cursor.description = [("id",), ("detected_at",), ("anomaly_type",), ("atm_id",), ("severity",), ("title",), ("explanation",)]
