...
class TestGetTimeBucketedAnomalies:
    def test_returns_empty_when_no_anomalies(self):
        ...
        with (
            patch("backend.src.analysis.metrics.get_conn", return_value=mock_conn),
    ...
    def test_with_anomaly_type_filter(self):
        ...
        with (
            ...
            result = get_time_bucketed_anomalies(
                hours=24, bucket_minutes=60, anomaly_type="A1"
            )
    ...
    def test_with_severity_filter(self):
        ...
        with (
            ...
            result = get_time_bucketed_anomalies(
                hours=24, bucket_minutes=60, severity="CRITICAL"
            )
    ...
    def test_with_is_active_filter(self):
        ...
        with (
            ...
            result = get_time_bucketed_anomalies(
                hours=24, bucket_minutes=60, is_active=True
            )
