...
class TestA1Detection:
    def test_fires_when_all_six_signals_present(self):
        ...
        assert anomalies[0]["sources_involved"] == [
            "ATM_APP",
            "KAFKA",
            "TERMINAL_HANDLER",
        ]
    ...
    def test_fires_when_jvm_memory_rises_and_oom_present(self):
        data = [
            ...
            },
            {
                ...
                "pod_name": "pod-1",
                "metric_value": 1040,
                "timestamp": "2024-01-01T11:29:00Z",
            },
            {
                "source": "TERMINAL_HANDLER",
...
class TestA7Detection:
        ...
        data = [
            {
                "source": "KAFKA",
                "atm_id": "ATM-A7",
                "raw_payload": json.dumps({"kafka_offset": 4050}),
                "timestamp": "2024-01-01T09:30:00Z",
                "atm_status": None,
            },
            {
                "source": "KAFKA",
                "atm_id": "ATM-A7",
                "raw_payload": json.dumps({"kafka_offset": 4051}),
    ...
    def test_ingestion_errors_pairs_produce_a7(self):
        ...
        ingestion_errors = [
            ...
            {
                "id": 2,
                "ts": datetime(2024, 1, 1, 9, 32, tzinfo=timezone.utc),
                "source": "KAFKA",
                "raw_input": "{}",
                "error_detail": "decode error",
            },
        ]
