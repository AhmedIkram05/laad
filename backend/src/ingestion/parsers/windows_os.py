...
WINDOWS_HEADERS = [
    ...
    'memory_total_mb','memory_usage_percent','disk_read_bytes_per_sec','disk_write_bytes_per_sec',
    'disk_free_gb','network_bytes_sent_per_sec','network_bytes_recv_per_sec','network_errors',
    'process_count','system_uptime_seconds','event_log_errors_last_min'
]
